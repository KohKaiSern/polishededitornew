...
const IDS = splitReadNew('constants/move_constants.asm');
const NAMES = splitReadNew('data/moves/names.asm');
const DESCS = splitReadNew('data/moves/descriptions.asm');
const ATTRS = splitReadNew('data/moves/moves.asm');
